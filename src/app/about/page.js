...
export const metadata = {
  title: "About Us | Fuse Bridge",
  description:
    "Learn about Fuse Bridge's story, mission, and core values. We fuse strategy, data, and creative technology to bridge your digital success.",
  openGraph: {
    title: "About Us | Fuse Bridge",
    description:
      "Fusing strategy, bridging success. Discover how Fuse Bridge drives measurable digital impact for commercial brands.",
    url: "https://fusebridgewebsite.com/about", // Replace with your production URL
      ...
      <section className="flex">
        <div className="w-full flex justify-center lg:m-4">
          <div className="relative w-full aspect-[2500/798]">
            <Image
              src="/illustrations/about-t.svg"
              alt="Fuse Bridge About Illustration"
              fill
              className="object-contain"
              priority
            />
